...
export const ChainIcon: React.FC<ChainIconProps> = ({ chain, size = 20, className, ...props }) => {
  const renderIcon = () => {
    switch (chain) {
      case 'eth':
        return (
          <g clipPath="url(#clip0_597_2890)">
            <path d="M9.75586 19.5C15.0026 19.5 19.2559 15.2467 19.2559 10C19.2559 4.75329 15.0026 0.5 9.75586 0.5C4.50915 0.5 0.255859 4.75329 0.255859 10C0.255859 15.2467 4.50915 19.5 9.75586 19.5Z" fill="#7A57DD"/>
            <path d="M9.75488 3.66663V8.34801L13.7116 10.1161L9.75488 3.66663Z" fill="white" fillOpacity="0.602"/>
            <path d="M9.75464 3.66663L5.79736 10.1161L9.75464 8.34801V3.66663Z" fill="white"/>
            <path d="M9.75488 13.1498V16.3307L13.7143 10.8529L9.75488 13.1498Z" fill="white" fillOpacity="0.602"/>
            <path d="M9.75464 16.3307V13.1493L5.79736 10.8529L9.75464 16.3307Z" fill="white"/>
            <path d="M9.75488 12.4135L13.7116 10.1161L9.75488 8.34912V12.4135Z" fill="white" fillOpacity="0.2"/>
            <path d="M5.79736 10.1161L9.75464 12.4135V8.34912L5.79736 10.1161Z" fill="white" fillOpacity="0.602"/>
          </g>
        );
      case 'arb':
        return (
          <>
            <path fill="#2d374b" d="m24.554 20.16 3.23-5.482 8.71 13.565.005 2.604-.029-17.915a1.35 1.35 0 0 0-.624-1.075l-15.68-9.02a1.38 1.38 0 0 0-1.339.087l-.055.034-15.22 8.82-.06.028a1.34 1.34 0 0 0-.787 1.146L2.73 27.55l8.113-12.574c1.02-1.667 3.246-2.205 5.313-2.175l2.424.064-14.286 22.91 1.684.97 14.457-23.857 6.39-.023-14.42 24.459 6.01 3.457.718.412c.303.124.661.13.968.02L36 31.996l-3.04 1.762zm1.232 17.757-6.069-9.526 3.705-6.287 7.971 12.564-5.607 3.25Z"/>
            <path fill="#28a0f0" d="m19.715 28.392 6.07 9.525 5.606-3.249-7.97-12.564zm16.783 2.455-.004-2.604-8.71-13.565-3.231 5.483 8.408 13.598L36 31.997c.298-.242.479-.597.498-.98z"/>
            <path fill="#fff" d="m0 33.302 4.293 2.474L18.58 12.865l-2.424-.064c-2.066-.03-4.291.508-5.313 2.175L2.73 27.55 0 31.743zm26.825-20.437-6.39.023L5.976 36.745l5.053 2.91 1.375-2.331 14.42-24.46Z"/>
            <path fill="#96bedc" d="M39.191 12.832a4.07 4.07 0 0 0-1.91-3.272L21.394.424a4.13 4.13 0 0 0-3.645 0C17.617.49 2.3 9.373 2.3 9.373a4.04 4.04 0 0 0-2.3 3.45v18.92l2.73-4.194-.024-14.599a1.35 1.35 0 0 1 .562-1.015c.071-.05 15.649-9.068 15.699-9.093a1.38 1.38 0 0 1 1.198-.006l15.68 9.02c.371.236.604.637.624 1.075v18.084c-.018.383-.17.739-.468.98l-3.04 1.763-1.569.909-5.607 3.249-5.685 3.295a1.38 1.38 0 0 1-.968-.02l-6.727-3.868-1.375 2.33 6.046 3.481.524.297c.226.127.38.211.435.238.43.209 1.048.33 1.605.33.51 0 1.009-.094 1.48-.278l16.515-9.564a4.04 4.04 0 0 0 1.556-3.042z"/>
          </>
        );
      case 'base':
        return (
          <path fill="#0052ff" d="M54.921 110.034c30.438 0 55.113-24.632 55.113-55.017S85.359 0 54.921 0C26.043 0 2.353 22.171 0 50.392h72.847v9.25H0c2.353 28.22 26.043 50.392 54.921 50.392"/>
        );
      case 'bitcoin':
        return (
      ...
      case 'sol':
        return (
          <>
            ...
            <linearGradient id="SolIcon_svg__a" x1="242.52" x2="755.68" y1="267.33" y2="-245.83" gradientTransform="matrix(.5 0 0 .5 0 250)" gradientUnits="userSpaceOnUse">
              <stop offset="0" style={{stopColor: 'rgb(203, 78, 232)'}}/>
              <stop offset="1" style={{stopColor: 'rgb(16, 244, 177)'}}/>
            </linearGradient>
            <path d="M115.6 226.1H347c2.9 0 5.6 1.1 7.6 3.2l36.6 36.8c6.8 6.8 2 18.4-7.6 18.4H152.2c-2.9 0-5.6-1.1-7.6-3.2L108 244.5c-6.8-6.7-2-18.4 7.6-18.4m-7.7-48.8 36.6-36.8c2.1-2.1 4.8-3.2 7.6-3.2h231.3c9.6 0 14.5 11.6 7.6 18.4l-36.5 36.8c-2 2.1-4.8 3.2-7.6 3.2H115.6c-9.6 0-14.4-11.6-7.7-18.4m283.2 156.2-36.6 36.9c-2 2-4.8 3.2-7.6 3.2H115.6c-9.6 0-14.4-11.6-7.7-18.4l36.6-36.9c2.1-2 4.8-3.2 7.6-3.2h231.3c9.7-.1 14.6 11.5 7.7 18.4" style={{fillRule: 'evenodd', clipRule: 'evenodd', fill: 'url(#SolIcon_svg__a)'}}/>
          </>
        );
      case 'zora':
        return (
          <>
            <path fill="url(#ZoraIcon_svg__a)" d="M70.615 141.23C31.615 141.23 0 109.615 0 70.615S31.616 0 70.615 0c39 0 70.615 31.615 70.615 70.615s-31.615 70.615-70.614 70.615Z"/>
            <defs>
              <radialGradient id="ZoraIcon_svg__a" cx="0" cy="0" r="1" gradientTransform="translate(102.676 37.972)scale(-119.284)" gradientUnits="userSpaceOnUse">
        ...
        {chain === 'eth' && (
          <defs>
            <clipPath id="clip0_597_2890">
              <rect width="19" height="19" fill="white" transform="translate(0.255859 0.5)"/>
            </clipPath>
          </defs>
        )}
      </svg>
