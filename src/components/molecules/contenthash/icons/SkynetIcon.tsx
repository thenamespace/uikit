interface SkynetIconProps {
  size?: number;
}

export const SkynetIcon = ({ size = 20 }: SkynetIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" style={{ color: 'rgb(0, 198, 94)' }}>
      <path 
        fill="#00c65e" 
