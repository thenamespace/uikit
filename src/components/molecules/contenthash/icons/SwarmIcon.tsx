...
export const SwarmIcon = ({ size = 20 }: SwarmIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size * 1.03} fill="none">
      <g fill="#FF8A00">
        ...
        <path d="m17.137 1.285-8.01 4.502v8.986l8.022 4.501 8.02-4.501v-3.58l-3.905-2.19-1.054-.59V3.119z" />
      </g>
    </svg>
  );
};
