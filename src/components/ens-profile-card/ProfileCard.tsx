        ...
        <div className="ns-profile-card">
            ...
            <div className="ns-profile-info">
                ...
                <div className="ns-profile-body">
                    <Text color="primary" weight="bold">{name}</Text>

                    <div className="ns-username-container">
                        <Text size="xl" weight="bold">{username}</Text>
                        <span className="ns-edit-btn">
                            <Icon name="edit" size={16} />
                        </span>
                    </div>

                    <Text size="md" className="ns-profile-bio">{bio}</Text>

                    {/* Socials + Copy Address */}
                    <div className="ns-profile-socials">
                        <div className="ns-address-box">
                            <Text color="grey" className="ns-address-text" size="sm">0x1234...abcd</Text>
                            <Icon name="copy" size={16} />
                        </div>
                        <Button><Icon name="twitter" color="#000000" size={16} /></Button>
                        <Button><Icon name="telegram" color="#000000" size={16} /></Button>
                        <Button><Icon name="globe" color="#000000" size={16} /></Button>
                        <Button><Icon name="github" color="#000000" size={16} /></Button>
                    </div>
