...
export const RecordsSelector = ({ onClose }: RecordsSelectorProps) => {
          ...
          >
            ...
            <>
              {textRecordMap.General.map(item => (
                <div
                  className="ns-text-record d-flex align-items-center"
                  key={item.key}
                >
                  <div className="ns-icon-cont d-flex align-items-center justify-content-center ns-me-1">
                    <Icon color="white" name={item.icon} size={12} />
                  </div>
            ...
            <>
              {textRecordMap.Social.map(item => (
                <div
                  ...
                  key={item.key}
                >
                  <div className="ns-icon-cont d-flex justify-content-center align-items-center ns-me-1">
                    <Icon color="white" name={item.icon} size={12} />
                  </div>
                  <Text weight="medium" size="sm">
                    {item.label}
